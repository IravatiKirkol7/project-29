...
function setup() {
  ...
  //second level
  BlockOrange1 = new BoxPink(201, 2, 20, 20);
  BlockOrange2 = new BoxPink(220, 2, 20, 20);
  BlockOrange3 = new BoxPink(240, 2, 20, 20);
  BlockOrange4 = new BoxPink(260, 2, 20, 20);
  BlockOrange5 = new BoxPink(280, 2, 20, 20);
  BlockOrange6 = new BoxPink(300, 2, 20, 20);BlockPink7 = new BoxPink(320, 2, 20, 20);
